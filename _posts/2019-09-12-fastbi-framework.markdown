...
Dentre as tarefas a serem realizadas podemos destacar as seguintes : 
a) verificação das necessidades a partir do ponto central e relacionadas ao projeto que serão desenvolvidas no sprint da iteração vigente.  b) Definir as perguntas a serem respondidas com base nas necessidades, realizar análise básica dos dados envolvidos; c) Selecionar, validar e armazenar os dados desejados para o sprint vigente 
